...
% st_Mr = (pl_rho*pl_H*pl_h^2)*(1+k*pl_sigma0)/((pl_rho*pl_H*pl_h^2)+(st_rho*st_A*st_h))
% pl_Mr = (st_rho*st_A*st_h)*(1+k*st_sigma0)/((pl_rho*pl_H*pl_h^2)+(st_rho*st_A*st_h));
...
if plot_on
  [sX,sY,sZ] = cylinder(st_r*ones(st_N,1));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Main Calculation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
