...
pl_L = .7;                       % plate length (m)
pl_Lx = .4;                       % plate length X axis (m)
...
tuning = [40,45]; % number and value of unique notes in MIDI sequence
...
exc_st = [0, 0];        % start times of excitation (s)
st_w0 = 1; st_v0 = 0;
st_ctr = .7; st_wid = .1;
